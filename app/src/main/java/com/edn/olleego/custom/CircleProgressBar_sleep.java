 ...
 */
public class CircleProgressBar_sleep   extends View {
    ...
    public CircleProgressBar_sleep(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        foregroundPaint.setColor(Color.parseColor("#98e56a"));
