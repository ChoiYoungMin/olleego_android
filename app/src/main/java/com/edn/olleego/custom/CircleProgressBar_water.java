 ...
 */
public class CircleProgressBar_water  extends View {
    ...
    public CircleProgressBar_water(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        foregroundPaint.setColor(Color.parseColor("#94eec1"));
