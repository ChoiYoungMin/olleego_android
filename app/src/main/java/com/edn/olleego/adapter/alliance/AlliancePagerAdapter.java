...
import com.edn.olleego.fragment.alliance.AllianceCenterListFragment;
 ...
 * <p/>
 * 제휴센터 리스트 pagerAdapter (전체, 피트니스, 필라테스...)
 */
public class AlliancePagerAdapter extends FragmentStatePagerAdapter {
    ...
    public AlliancePagerAdapter(FragmentManager fm, int tabCount, List<AllianceCategoryModel> list, double lon, double lat) {
        super(fm);
    ...
    public Fragment getItem(int position) {
        ...
        return new AllianceCenterListFragment().newInstance(value, id, lon, lat);
    }
